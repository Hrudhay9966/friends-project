...
import { darkSecondary, FriendsInBlue, FriendsInLightBlue } from "Colors";
...
export default makeStyles((theme) => ({
  ...
  header__form: {
    ...
    "& > button": {
      ...
      border: 0,
      outlineWidth: 0,
      backgroundColor: theme.palette.type === "dark" ? FriendsInLightBlue : FriendsInBlue,
      color: "white",
      cursor: "pointer",
      fontWeight: 600,
      transition: "all 0.4s ease",
      "&:hover": {
        backgroundColor: theme.palette.type === "dark" ? FriendsInBlue : FriendsInLightBlue,
      },
    },
  },
