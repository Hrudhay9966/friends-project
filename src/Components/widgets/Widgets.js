...
import { FriendsInLightBlue,FriendsInBlue } from "../../assets/Colors";
import { FriendsInJobAdd } from "../../assets/images";
    ...
    <div className={classes.widgets}>
        ...
        {expand &&
          top_2.map((title, i) => (
            <HeaderInfo
              ...
              Icon={<FiberManualRecordIcon style={{ color: FriendsInBlue, fontSize: 12 }} />}
              title={title}
              time={true}
              count={true}
            />
      ...
      <div className={classes.widgets__bottom}>
        <Paper className={classes.addBanner}>
          <img src={FriendsInJobAdd} alt="Friends-in-jub-add" />
        </Paper>
        {/* About Author */}
